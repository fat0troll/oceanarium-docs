**Oceanarium** is a Ruby/Rails gem which provides you access to Digital Ocean API. You don´t need to parse anything manually — Oceanarium will do all the magic for you!
